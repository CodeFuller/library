...
namespace CF.Library.Core
{
	...
	public static class RandomExtensions
	{
		...
		public static long NextLong(this Random rnd, long minValue, long maxValue)
		{
			...
			{
				throw new ArgumentOutOfRangeException(FormattableString.Invariant($"{nameof(minValue)} > {nameof(maxValue)}"));
			}
		...
		public static string NextString(this Random rnd, string charSet, int minLength, int maxLength)
		{
			...
			{
				throw new ArgumentOutOfRangeException(FormattableString.Invariant($"{nameof(minLength)} > {nameof(maxLength)}"));
			}
		...
		{
			return new Uri(FormattableString.Invariant($"http://{GenerateDomainPart(rnd)}.{GenerateDomainPart(rnd)}.{GenerateDomainPart(rnd)}/{rnd.NextString()}"));
		}
